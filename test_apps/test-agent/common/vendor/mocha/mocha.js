...
function Base(runner) {
  ...
  runner.on('pass', function(test){
    ...
    /* <Mozilla> use internal properties because they're still there after json
     * serialization/deserialization </Mozilla> */
    var medium = test._slow / 2;
    test.speed = test.duration > test._slow
      ? 'slow'
